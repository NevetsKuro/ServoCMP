    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#createdSample1 > tbody > tr > td:not(:first-child):not(:nth-child(2)):not(:nth-child(10))', function () {
                ...
                var colNum = td.index();
                $.ajax({
                    url: '/ServoCMP/LabAdmin/GetTseReportsDetails?rowCode=' + rowCode + '&colNum=' + colNum + '&fromDate=' + $("#fromDate").val() + '&toDate=' + $("#tosDate").val() + '&report=LabCSLEfficiencyReport',
                    type: 'GET',
                    dataType: 'JSON',
...
//                }
            ...
            $(document).on('click', '#btnGenerate', function (e) {
                ...
                if (todate > fromdate) {
                    $.ajax({
                        url: '${pageContext.request.contextPath}/LabAdmin/LabCSLEfficiencyReport?fromDate=' + $("#fromDate").val() + '&toDate=' + $("#tosDate").val() + '&logIt=no',
                        type: 'POST',
                        dataType: 'JSON',
                        success: function (data) {
                            console.log(data);
