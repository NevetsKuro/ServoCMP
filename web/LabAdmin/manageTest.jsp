<html>
    ...
    <body>
        <div class="container-fluid">
            <h4 class="centre-btn" style="text-decoration: underline">Manage Test(s)</h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form role="form" class="form-inline" action="#" method="POST" id="updateTestForm">
                        ...
                        <input type="hidden" id="role" name="role" value="labAdmin"/>
                        ...
                        <div class="modal-body container-fluid">
                            <div class="floating-label-form-group floating-label-form-group-with-value col-xs-offset-3 col-xs-6 removedTest">
                                ...
                                <select id="testNameModal" name="testNameModal" style="width: 100%; box-shadow: none" class="form-control upperCase">
                            ...
                            <div class="hideActive">
                                <div class="row vertical-center-row hideActive">
                                    <div class="form-group col-xs-4 floating-label-form-group floating-label-form-group-with-value" style="border-left: none">
                                        <label>Test Name <span class="text-danger">*</span></label>
                                        <input type="text" id="testName" name="testName" class="form-control upperCase" placeholder="Enter Test Name" style="width: 100%" maxlength="35"/>
                                    </div>
                                    <div class="form-group col-xs-4 floating-label-form-group floating-label-form-group-with-value">
                                        <label>Test Unit <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-xs-4 floating-label-form-group floating-label-form-group-with-value">
                                        ...
                                        <input type="text" id="methodName" name="methodName" class="form-control upperCase" placeholder="Enter Method Name" style="width: 100%" maxlength="45"/>
                                    </div>
                                </div>
                                <div class="row vertical-center-row">
                                    <div class="form-group col-xs-3 floating-label-form-group floating-label-form-group-with-value">
                                        <label>Required Qty of Sample <span class="text-danger">*</span></label>
                                        <input type="text" id="sampleQty" name="sampleQty" class="form-control" placeholder="Enter Quantity of sample" title="Quantity of Sample Required for testing this Sample" style="width: 100%" maxlength="6" onkeypress="javascript: return isNumber(event)" value="0"/>
                                    </div>
                                    <div class="form-group col-xs-9 floating-label-form-group floating-label-form-group-with-value">
                                        <label>Display Position <span class="text-danger">*</span></label>
                                        <input type="number" min="0" id="dispSeq" name="dispSeq" class="form-control" placeholder="Enter position of sample" title="Position of Test among other test" style="width: 100%" maxlength="4" onkeypress="javascript: return isNumber(this)" value="0"/>
                                    </div>
                                </div>
                            </div>
                        </div>
