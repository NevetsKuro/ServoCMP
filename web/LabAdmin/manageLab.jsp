<html>
    <jsp:include page="../UItemplate/header.jsp">
        <jsp:param name="title" value="Manage Lab"/>
    </jsp:include>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <body>
        <div class="container-fluid">
            <h4 class="centre-btn" style="text-decoration: underline">Manage Lab(s)</h4>
            <div style="width: 70%; margin-left: auto; margin-right: auto">
                <button class ="btn btn-primary btn-group-sm" onclick="AddIndustry('Add Industry')" data-toggle="tooltip" data-placement="bottom" title="Add Customer to Master Records">Add Industry</button>
                <button style="float: right" class ="btn btn-primary btn-group-sm right" onclick="removeIndustry('Remove Industry')" data-toggle="tooltip" data-placement="bottom" title="Inactive Industries">Removed Industries</button>
                <br/><br/>
                        ...
                        <div class="modal-body container-fluid">
                            <div class="row vertical-center-row">
                                <div class="form-group col-xs-offset-3 col-xs-6 floating-label-form-group floating-label-form-group-with-value" style="border-left: none">
                                    ...
                                    <select id="industryNameModal" name="industryId" style="width: 100%; box-shadow: none" class="form-control">
                                    ...
                                    <div class="hideActive">
                                        <select multiple="multiple" id="industryNameInput" name="industryNameInput" style="width: 100%; box-shadow: none" class="form-control" placeholder="">
                                            <option></option>
                                            <c:forEach items="${Industries}" var="industry">
                                    ...
                                    <div class="hideIndustryEdit">
                                        <input type="text" id="industryEdit" name="industryNameEdit" class="form-control" placeholder="Enter Industry Name" style="width: 100%"/>
                                    </div>
