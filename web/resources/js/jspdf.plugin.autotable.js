if (typeof window === 'object')
    window.jspdfAutoTableVersion = '2.3.0';
        ...
        return __webpack_require__(__webpack_require__.s = 35);
            ...
            ([
                function (module, exports, __webpack_require__) {
                    ...
                    exports.getTheme = function (name, color) {
                        var themes = {
                            'striped': {
                            ...
                            'plain, [54, 95, 145]': {
                                table: {fillColor: 255, fontStyle: 'normal', lineWidth: 0.5, textColor: [54, 95, 145], lineColor: [79, 129, 189]},
                                header: {},
                                body: {},
                                alternateRow: {fillColor: [211, 223, 238]}
                            },
                            'plain, 0': {
                                table: {fillColor: 255, fontStyle: 'normal', lineWidth: 0.5, textColor: 0, lineColor: [155, 187, 89]},
                                header: {},
                                body: {},
                                alternateRow: {fillColor: [230, 238, 213]}
                            },
                            'plain, [60, 70, 143]': {
                                table: {fillColor: 255, fontStyle: 'normal', lineWidth: 0.5, textColor: 0, lineColor: [60, 70, 143]},
                                header: {},
                                body: {fontSize: 7},
