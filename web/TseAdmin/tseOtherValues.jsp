            ...
            <div class="row">
                <section>
                    <div style="border-top: 1px solid lightgrey;">
                        ...
                        <span id="getOVSummary" class="btn btn-primary btn-toolbar" style="float: right;margin-top: 10px" data-emp-code="${sUser.sEMP_CODE}"><i class="fa fa-sync"></i> Get Data</span>
                    </div>
