<html>
    <jsp:include page="../UItemplate/header.jsp">
        <jsp:param name="title" value="Sample(s) Forwarded to Customer"/>
    </jsp:include>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <body>
        <div class="text-center">
            <h4 class="text-center text-info text-primary">Sample(s) Forwarded to Customer</h4>
            ...
            <label class="text-info"><u>Single Sample Type</u>&nbsp; &rarr;&nbsp; </label>
            <span class="defFont" style='color:mediumvioletred'><i class='glyphicon glyphicon-file'></i></span>
            <span class="spacespace"></span>
            <label class="text-info"><u>Normal Sample Type</u>&nbsp; &rarr;&nbsp; </label>
        ...
        <div class="row">
            ...
            <div class="col-1" style="margin-top: 30px">
                <div class="col-xs-1" style="padding-top: 10px">
                    <button id="filterSearchfrLab" class="btn btn-default btn-success" data-status="4" data-toggle="tooltip" data-placement="bottom" title="Search Records by Product Name">Search By</button>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container-fluid body-content">
            <table id="sampleToCustomer" class="table table-bordered table-hover tbCenter-head cursorOnHoverTable" cellspacing="0" width="100%">
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click','#sampleToCustomer > tbody > tr',function () {
//                    var id = $('#sentToCustomer > tbody > tr:nth-child(1)').find('td:nth-child(1)').html().trim();
                    ...
                    window.open('${pageContext.request.contextPath}/Lab/getSampleTestResult?smplid='+id+'&labCode='+labCode+'&status=4&csrftoken=${sessionScope.csrfToken}');
                });
