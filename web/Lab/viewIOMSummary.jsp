...
<html>
    ...
    <body>
        ...
        <form role="form" action="${pageContext.request.contextPath}/Lab/GetIOMSummaryDetails" id="iom" class="form-inline" method="post">
...
<!--            <div class="row centre-btn">
        ...
        <div class="container-fluid">
            <div style="width: 50%; margin: 0 auto">      
                <table id="iomSumTbl" class="table table-bordered tbCenter-head"  cellspacing="0" >
                        ...
                        <c:forEach items="${lstIOMs}" var="data" varStatus="count">
                            <tr style="font-size:small" class="">
                                <td class="text-center">
                                    <a href="${pageContext.request.contextPath}/Lab/GetIOMWiseSummaryData?iomRefNo=${data.iomRefNo}&date=${data.strIomCreatedDate}&nameLabLocCode=${labLocCode}&sEmpCod=${data.createdBy}&csrftoken=${sessionScope.csrfToken}" title="Click to view the IOM wise summary data"> ${data.iomRefNo}</a>
                                </td>
                                <td class="NevsLeft">${data.mstLab.labName}</td>
