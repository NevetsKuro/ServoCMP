...
<html>
    ...
    <jsp:include page="../UItemplate/header.jsp">
        <jsp:param name="title" value="Send Sample to Lab for Testing"/>
    </jsp:include>
    <body>
        ...
        <div class="container-fluid">
            <h4 class="text-center text-info tbCenter" style="text-decoration: underline">Send ${sampleType} Sample(s) to Laboratory</h4>
            ...
            <div class="row">
                ...
                <div class="col-1" style="margin-top: 30px">
                    <div class="col-xs-1" style="padding-top: 10px">
                        <button id="filterSearchfrSC" class="btn btn-default btn-success" data-status="1" data-toggle="tooltip" data-placement="bottom" title="Search Records by Product Name">Search By</button>
                    </div>
                </div>
            </div>
            <br>
            <br>
            <table id="createdSample" class="table table-bordered table-hover tbCenter" cellspacing="0" width="100%">
                <thead style="font-size: x-small">
                <th style="width: 84px">LAB<br/>TYPE</th>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click','#createdSample > tbody > tr',function () {
//                    var id = $('#sentToCustomer > tbody > tr:nth-child(1)').find('td:nth-child(1)').html().trim();
                    ...
                    if(sampleType){
                        window.open('${pageContext.request.contextPath}/Tse/GetUpdateSample?smplid='+id+'&sampleType='+sampleType+'&labCode='+labCode+'&status=1&csrftoken=${sessionScope.csrfToken}');
                    }
                });
