    ...
    <body onload="validate(); loadImages();">
        ...
        <div class="container-fluid">
                            ...
                            <tr>
                                <c:choose>
                                    <c:when test="${sample.mstLab.labType eq 'CSL'}">
                                        <td style="text-align: center;"><label>CSL Lab Details</label></td>
                                    </c:when>
                                    <c:otherwise>
                                        <td style="text-align: center;"><label>RND Lab Details</label></td>
                                    </c:otherwise>
                                </c:choose>
                                <td></td>
                                <td></td>
                            ...
                            <c:if test="${sample.fileuploadStatus eq 'YES'}">
                                <div class="form-group col-md-6 text-center" style="border-bottom: 1px solid darkgray; padding: 14px;">
                                    <label title="Click to choose this file to send as mail attachment">
                                        ...
                                        : <a href="${pageContext.request.contextPath}/DownloadUploadedFile?smplid=${sample.sampleId}&labCode=${sample.mstLab.labCode}&roleDoc=LAB&csrftoken=${sessionScope.csrfToken}" target="_blank" title="Click to download Attachment"><span class="glyphicon glyphicon-download-alt"></span> ${sample.sampleId}</a>
                                    </label>
                                </div>
                            </c:if>
            ...
            <div class="form-group centre-btn form-inline">
                ...
                <a onclick="window.close()" data-toggle="tooltip" data-placement="top" title="Summary of samples for which test results have been sent to Customer" class="btn-primary form-control cursorOnHover" style="margin-right: 20px; text-decoration: none">CLOSE</a>
