<%-- 
    Document   : viewSentToCustSampleSummary
    Created on : 1 Apr, 2017, 2:21:52 PM
    Author     : 00507469
--%>
<html>
    <jsp:include page="../UItemplate/header.jsp">
        <jsp:param name="title" value="Sample(s) Send to Customer"/>
    </jsp:include>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h4 class="text-center text-info" style="text-decoration: underline">Send ${sampleType} Sample to Customer</h4>
            ...
            <div class="row">
                ...
                <div class="col-1" style="margin-top: 30px">
                    <div class="col-xs-1" style="padding-top: 10px">
                        <button id="filterSearchfrSC" class="btn btn-default btn-success" data-status="4" data-toggle="tooltip" data-placement="bottom" title="Search Records by Product Name">Search By</button>
                    </div>
                </div>
            </div>
            <br>
            <br>
            <table id="sentToCustomer" class="table table-bordered table-hover tbCenter" cellspacing="0" width="100%">
                <thead style="font-size: x-small">
                <th style="width: 90px">LAB<br/>TYPE</th>
                <th style="width: 100px;">EDIT<br/> SAMPLE ID</th>
                ...
                <th style="width:77px">CREATED ON</th>
                </thead>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click','#sentToCustomer > tbody > tr',function () {
//                    var id = $('#sentToCustomer > tbody > tr:nth-child(1)').find('td:nth-child(1)').html().trim();
                    ...
                    if(sampleType){
                        window.open('${pageContext.request.contextPath}/Tse/GetTestResultsDetails?smplid='+id+'&sampleType='+sampleType+'&labCode='+labCode+'&type=READ&csrftoken=${sessionScope.csrfToken}');
                    }
                });
            });
        </script>
...
<!--
<a href="${pageContext.request.contextPath}/Tse/GetTestResultsDetails?smplid=${data.sampleId}&type=READ" title="Click to edit Sample details sent to Lab">-->
        <!--</a>-->
    <tr style="font-size:small;cursor: pointer;" class="priorityLevel${data.samplepriorityId}">
