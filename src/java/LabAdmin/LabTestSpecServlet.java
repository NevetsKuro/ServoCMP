...
public class LabTestSpecServlet extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (isAjax(request)) {
            List<MstTest> mstTest = MstProdTest.getLabProdTest(request.getParameter("proName"));
            Gson gson = new Gson();
            ...
            List<MstTest> mTest = MstProdTest.getAllLabTest();
