...
public class LabAdminFilter implements Filter {

    private static final boolean debug = true;

    private FilterConfig filterConfig = null;

    public LabAdminFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("LabAdminFilter:DoBeforeProcessing");
        }
    }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("LabAdminFilter:DoAfterProcessing");
        }
    }
...
//                    if(storedToken.equals(receivedToken)){
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null && debug) {
            log("LabAdminFilter:Initializing filter");
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("LabAdminFilter()");
        }
        StringBuilder sb = new StringBuilder("LabAdminFilter(");
